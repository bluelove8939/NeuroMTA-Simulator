#ifndef __NEUROMTA_DMA_MODULE_H
#define __NEUROMTA_DMA_MODULE_H
...
class HBM2DMAModule: protected DMAModule {
public:
    HBM2DMAModule(
        const int ref_clock_freq,
...
class DRAMSim3DMAModule: public Module {
protected:
